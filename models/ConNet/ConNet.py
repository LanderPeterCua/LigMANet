...
from models.ConNet.utils import *
...
class ConNet(nn.Module):
    ...
    def forward(self, x_in):
        ...
        xb3 = F.interpolate(xb4, size=[math.ceil(x_in.shape[2]/8), math.ceil(x_in.shape[3]/8)], mode='bilinear') #1/8 size, 512
        ...
        xb2 = F.interpolate(xb3, size=[math.ceil(x_in.shape[2]/4), math.ceil(x_in.shape[3]/4)], mode='bilinear') #1/4 size, 256
        ...
        xb1 = F.interpolate(xb2, size=[math.ceil(x_in.shape[2]/2), math.ceil(x_in.shape[3]/2)], mode='bilinear') #1/2 size, 128
